...
rmpath(genpath(strcat(pwd, '\gearShift_loadSync\ModelParams\')));
rmpath(genpath(strcat(pwd, '\gearShiftDown_loadSync\ModelParams\')));

%% Visulization of params of model

MyPlot.showParams('Wi1', 1); % Wi = concat [Whi; Wxi]
...
load('gearShiftUp_loadSync\DataFinalSave\list_data\listStructTrain.mat');
...
load('gearShiftUp_loadSync\DataFinalSave\list_data\listStructTest.mat');
...
margin = 0.7 ; % 'max.' excite the neuron
...
load('gearShiftUp_loadSync\DataFinalSave\list_data\listStructTest.mat');
load('common\src\signalTable.mat');
load neuronPatternSArr_lstm_positive_test.mat

listStruct = listStructTest;
range_neurons = [ 26 ]; %
range_id = [1:100]; % total train
subplotRows = 1; % subplot(subplotRows, subplotCols, ?)
subplotCols = 2;
...
load('gearShiftUp_loadSync\DataFinalSave\list_data\listStructTest.mat');
load('common\src\signalTable.mat');
load neuronPatternSArr_lstm_negative_test.mat
