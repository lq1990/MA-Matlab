function bi = importfile_bi(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   BI = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   BI = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   bi = importfile('bi.txt', 1, 1);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/08/16 22:23:09
