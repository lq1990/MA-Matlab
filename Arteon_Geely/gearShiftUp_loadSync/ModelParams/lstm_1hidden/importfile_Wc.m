function Wc = importfile_Wc(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   WC = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   WC = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   Wc = importfile('Wc.txt', 1, 71);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/08/16 22:23:53
