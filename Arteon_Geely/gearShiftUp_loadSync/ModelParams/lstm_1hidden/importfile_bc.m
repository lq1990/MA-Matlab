function bc = importfile_bc(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   BC = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   BC = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   bc = importfile('bc.txt', 1, 1);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/08/16 22:22:08
