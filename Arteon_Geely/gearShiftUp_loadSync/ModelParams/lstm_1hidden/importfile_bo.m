function bo = importfile_bo(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   BO = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   BO = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   bo = importfile('bo.txt', 1, 1);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/08/16 22:25:00
