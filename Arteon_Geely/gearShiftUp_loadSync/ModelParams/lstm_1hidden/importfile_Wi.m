function Wi = importfile_Wi(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   WI = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   WI = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   Wi = importfile('Wi.txt', 1, 71);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/08/16 21:12:32
