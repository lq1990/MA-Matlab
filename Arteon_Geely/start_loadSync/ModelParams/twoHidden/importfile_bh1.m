function bh1 = importfile_bh1(filename)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   BH1 = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   BH1 = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   bh1 = importfile('bh1.txt', 1, 50);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/06/17 11:04:57
