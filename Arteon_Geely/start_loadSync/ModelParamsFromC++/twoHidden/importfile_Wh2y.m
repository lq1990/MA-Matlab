function Wh2y = importfile_Wh2y(filename)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   WH2Y = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   WH2Y = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   Wh2y = importfile('Wh2y.txt', 1, 10);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/06/17 11:04:31
