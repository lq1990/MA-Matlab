function Wh1h1 = importfile_Wh1h1(filename)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   WH1H1 = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   WH1H1 = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   Wh1h1 = importfile('Wh1h1.txt', 1, 50);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/06/17 11:03:04
