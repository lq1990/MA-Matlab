function bf = importfile_bf(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   BF = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   BF = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   bf = importfile('bf.txt', 1, 1);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/08/16 22:22:46
