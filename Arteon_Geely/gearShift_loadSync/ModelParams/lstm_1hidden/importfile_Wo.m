function Wo = importfile_Wo(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   WO = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   WO = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   Wo = importfile('Wo.txt', 1, 71);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/08/16 22:25:18
