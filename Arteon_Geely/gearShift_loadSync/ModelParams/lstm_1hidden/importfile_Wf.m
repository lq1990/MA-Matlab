function Wf = importfile_Wf(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   WF = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   WF = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   Wf = importfile('Wf.txt', 1, 71);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/08/16 22:24:28
