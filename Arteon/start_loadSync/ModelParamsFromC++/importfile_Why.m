function Why = importfile_Why(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   WHY = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   WHY = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   Why = importfile_Why('Why.txt', 1, 5);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/04/21 18:34:45
