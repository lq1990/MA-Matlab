function lossall = importfile_lossall(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   LOSSALL = IMPORTFILE(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   LOSSALL = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   lossall = importfile_lossall('loss_all.txt', 1, 10020);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/04/21 18:41:20
