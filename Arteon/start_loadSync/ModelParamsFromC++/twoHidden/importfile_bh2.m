function bh2 = importfile_bh2(filename)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   BH2 = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   BH2 = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   bh2 = importfile('bh2.txt', 1, 50);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/06/17 11:05:22
