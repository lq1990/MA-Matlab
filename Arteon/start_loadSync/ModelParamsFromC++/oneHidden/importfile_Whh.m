function Whh = importfile_Whh(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   WHH = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   WHH = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   Whh = importfile_Whh('Whh.txt', 1, 50);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/04/21 18:32:11
