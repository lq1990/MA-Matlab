function bh = importfile_bh(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   BH = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   BH = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   bh = importfile_bh('bh.txt', 1, 50);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/04/21 18:37:18
